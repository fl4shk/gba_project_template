...
# In both this makefile (makefile_for_updated_gcc.mk) and the devkitARM
# makefile (makefile_devkitARM.mk), the contents after the creation of the
# LD_FLAGS variable are supposed to be the same.
